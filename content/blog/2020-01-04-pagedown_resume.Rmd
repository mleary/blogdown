...
*  Create two versions, an [HTML document](https://mattleary-resume.netlify.com/){target="_blank"} for the web and a [basic pdf](https://github.com/mleary/resume/blob/master/mleary_resume.pdf){target="_blank"} for printing
