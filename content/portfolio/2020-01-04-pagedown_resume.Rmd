---
title: "Creating my resume with the pagedown package"
author: "Matt Leary"
date: 2020-01-04
...
*  Create two versions, an [HTML document](https://mattleary-resume.netlify.com/)for the web and a [basic pdf](https://github.com/mleary/resume/blob/master/mleary_resume.pdf) for printing
*  Develop a process that made it easy to update my resume periodically [(see the repo here).](https://github.com/mleary/resume)
...
After some quick research on **pagedown** examples, I stumbled upon Nick Strayer's resume.  I liked the subtle changes he made to the base **pagedown::html_resume**, and decided to leverage his format & appproach.  For example, I really liked his use of "skill bars" to highlight his coding experience.

```{r}
resume_data <- openxlsx::read.xlsx("https://github.com/mleary/resume/raw/master/resume_data.xlsx", sheet = 2)
devtools::source_url("https://raw.githubusercontent.com/mleary/resume/master/helper_functions.R")

build_skill_bars(resume_data, "Coding")
...
The process was relatively straightforward and lead to learning several new R tips that could be applied elsewhere.  My major takeways are listed below.
...
* CSS styling is nuanced, but it also adds a lot.  As a data scientist I am not a CSS expert, but with some simple research and a LOT of experimentation I was able to quickly make changes.  I've used CSS to create a custom **rmarkdown** template at work, and that little addition really makes the report stand out.
