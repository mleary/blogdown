...
author: "Matt Leary"
date: '2019-07-05'
summary: "With my team's use of Trello to track and monitor our workflow, I wantedto explore ways to capture that data via an API.  Without fail, there was an R package built by Jakub Chromec for that very purposes."
tags: ["API"]
categories: ["R"]
---
