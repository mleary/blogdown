...
thumnnailImage: /img/Champions_League_Race.png
...
The 2018// 2019 Premier League season is coming to close.  While Manchester City and Liverpool have locked in the top two positions, the race to secure Champions League football by finishing in 3rd and 4th place has been up for grabs.  Chelsea, Tottenham, Arsenal and Manchester United have all had oppurtunites to move into the top four finish, but all four teams have struggled in form.  For example, let's look at their performance over the past 12 match weeks compared to the rest of the season.
...
As an avid Tottenham Hotspur supporter, I was pretty disappointed that we went from best performance to worst performance amongst the teams.  Not only that, our average points  per game dropped by 1.2 points per game!  In a game    In most cases we would have been overtaken, given our poor run of form, but fortunately the other teams said "hold my beer" and had managed to play to our level as well.

I decided to take a look and see how each team perfomance has dropped off. I didn't find easy access to cummulative points by match week, so I decided to use ClubElo rating as a proxy for overall performance.
...
Improvements:
This was a quick 
For the future, I hope to have better data such as cummalative points per match week for each team. It also would have been nice to publish 
